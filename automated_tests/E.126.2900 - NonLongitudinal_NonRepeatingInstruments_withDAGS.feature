Feature: E.126.2900 - NonLongitudinal_NonRepeatingInstruments_withDAGS
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.126.2900" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/redcap_val/ProjectTypes/NonLongitudinal_NonRepeatingInstruments_withDAGS.xml", and clicking the "Create Project" button
