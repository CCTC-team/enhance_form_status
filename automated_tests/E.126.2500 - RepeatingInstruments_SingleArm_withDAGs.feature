Feature: E.126.2500 - RepeatingInstruments_SingleArm_withDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.126.2500" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/redcap_val/ProjectTypes/RepeatingInstruments_SingleArm_withDAGs.xml", and clicking the "Create Project" button
