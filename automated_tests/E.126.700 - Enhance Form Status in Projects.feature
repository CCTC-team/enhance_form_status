Feature: E.126.700 - The system shall support the ability to attach form status to the foot of the data entry form using Enhance Form Status module.
  ...
  Scenario: E.126.100 - Disable external module
    ...
    Then I should see a table header and row containing the following values in the logging table:
      ...
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_form_status_v1.1.0" for project                  |                                                                                           |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_form_status_v1.1.0" for project | show-form-status-inline                                                                   |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_form_status_v1.1.0" for project | show-form-status-inline, text-representing-in-progress, ignore-for-form-status-check      |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_form_status_v1.1.0" for project | reserved-hide-from-non-admins-in-project-list, user-roles-can-update, user-roles-can-view |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_form_status_v1.1.0" for project                   |                                                                                           |
    ...
    Then I should see a table header and row containing the following values in a table:
      | Time             | User       | Event                                                                             |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_form_status_v1.1.0" for system                   |
      | mm/dd/yyyy hh:mm | test_admin | Disable external module "enhance_form_status_v1.1.0" for project                  |
      | mm/dd/yyyy hh:mm | test_admin | Modify configuration for external module "enhance_form_status_v1.1.0" for project |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_form_status_v1.1.0" for project                   |
      | mm/dd/yyyy hh:mm | test_admin | Enable external module "enhance_form_status_v1.1.0" for system                    |
