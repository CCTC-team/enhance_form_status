...
Scenario: E.126.400 - Allow non-admins to enable this module on projects
    ...
    When I create a new project named "E.126.400" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
