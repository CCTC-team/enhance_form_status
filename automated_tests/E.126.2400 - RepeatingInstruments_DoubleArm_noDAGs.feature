Feature: E.126.2400 - RepeatingInstruments_DoubleArm_noDAGs
  ...
  Scenario: Enable external module in project
    Given I create a new project named "E.126.2400" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/redcap_val/ProjectTypes/RepeatingInstruments_DoubleArm_noDAGs.xml", and clicking the "Create Project" button
