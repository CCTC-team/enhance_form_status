...
Scenario: E.126.300 - Make module discoverable by users
    ...
    When I create a new project named "E.126.300" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "fixtures/cdisc_files/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
    ...
    When I click on the button labeled "Request Activation" in the row labeled "Enhance form status"
    ...
    # And I should see the "Activate external module" request created for the project named "E.126.300" within the Pending Requests table
    # When I click on the process request icon for the "Activate external module" request created for the project named "E.126.300" within the Pending Requests table
    # # HTML is not loading into iFrame
    # Then I should see "Enable module 'Enhance form status - '?" in the iframe
    # And I click on the button labeled "Enable" in the iframe
    # And I close the iframe window
    # Then I should see the "Activate external module" request created for the project named "E.126.300" within the Completed & Archived Requests table
    # And I logout

    # Given I login to REDCap with the user "Test_User1"
    # When I click on the link labeled "My Projects"
    # And I click on the link labeled "E.126.300"
    # And I click on the link labeled "Manage"
    # Then I should see "External Modules - Project Module Manager"
