Feature: E.126.3100 - The system shall support the ability to configure 'Module configuration permissions in projects' for Enhance form status external module.

  As a REDCap end user
  I want to see that Enhance form status is functioning as expected

Scenario: E.126.3100 - Module configuration permissions in projects
    ...
    When I create a new project named "E.126.3100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/Project_redcap_val_nodata.xml", and clicking the "Create Project" button
    ...
    And I click on the link labeled "E.126.3100"
...
Scenario: E.126.600 - View Usage of the external module
    ...
    And I should see a link labeled "E.126.3100" in the dialog box
    When I click on the link labeled "E.126.3100" in the dialog box
    Then I should see "Project Home"
    And I should see "E.126.3100"
